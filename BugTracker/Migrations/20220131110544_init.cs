            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    historyid = table.Column<int>(nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    attribute = table.Column<string>(unicode: false, maxLength: 80, nullable: true),
                    oldvalue = table.Column<string>(unicode: false, maxLength: 80, nullable: true),
                    newvalue = table.Column<string>(unicode: false, maxLength: 80, nullable: true),
